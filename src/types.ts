...
export type Amenity = {
  __typename?: 'Amenity';
  /** The amenity category the amenity beloings to */
...
export type Query = {
  __typename?: 'Query';
  /** A curated array of listings ot feature on the homepage */
  featuredListings?: Maybe<Array<Listing>>;
...
export type QueryResolvers<ContextType = DataSourceContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  featuredListings?: Resolver<Maybe<Array<ResolversTypes['Listing']>>, ParentType, ContextType>;
